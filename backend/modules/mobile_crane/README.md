...
Slug: `mobile_crane` &nbsp;|&nbsp; Report prefix: `MBC` &nbsp;|&nbsp; Validity: 12 months
...
2. Drop the approved Word template into `templates/mobile_crane_report_template.docx`.
...
- `GET /api/modules/mobile_crane/manifest`
- `GET /api/modules/mobile_crane/form-schema`
- `GET /api/modules/mobile_crane/stats`
